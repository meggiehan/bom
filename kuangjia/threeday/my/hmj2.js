/*
* @Author: Marte
* @Date:   2017-01-13 19:36:39
* @Last Modified by:   Marte
* @Last Modified time: 2017-01-13 19:52:06
*/
...
//一些判断的方法
    ...
    hmj.isString=function(data){
        return typeof data==='string';
    }
     hmj.isFunction=function(data){
       return typeof data==='function';
    }
     hmj.isDOM=function(data){
        if(data.nodeType){
            return true;
        }
        return false;
